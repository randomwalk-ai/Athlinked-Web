        ...
        <div className=" mx-auto bg-white rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="border border-[#E5E5E5] border-2 rounded-lg p-6 bg-white">
              ...
              <h3 className="text-2xl font-bold text-[#171717] mb-2">Networking</h3>
            ...
            <div className="border border-[#E5E5E5] border-2 rounded-lg p-6 bg-white">
              ...
              <h3 className="text-2xl font-bold text-[#171717] mb-2">Stats Tracking</h3>
              <p className="text-[#525252] text-lg">
            ...
            <div className="border border-[#E5E5E5] border-2 rounded-lg p-6 bg-white">
              ...
              <h3 className="text-2xl font-bold text-[#171717] mb-2">AthScore</h3>
              <p className="text-[#525252] text-lg">
            ...
            <div className="border border-[#E5E5E5] border-2 rounded-lg p-6 bg-white">
              ...
              <h3 className="text-2xl font-bold text-[#525252] mb-2">Dynamic Profiles</h3>
              <p className="text-[#525252] text-lg">
        ...
        <div className=" mx-auto bg-white rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="border border-[#E5E5E5] border-2 rounded-lg p-6 bg-white">
              ...
              <h3 className="text-2xl font-bold text-[#171717] mb-2">For Athletes</h3>
              <p className="text-[#525252] text-lg">
                Connect directly with coaches, recruiters, and other athletes to expand your opportunities.
              </p>
            </div>
            ...
            <div className="border border-[#E5E5E5] border-2 rounded-lg p-6 bg-white">
              ...
              <h3 className="text-2xl font-bold text-[#171717] mb-2">For Parents</h3>
              <p className="text-[#525252] text-lg">
                Track and visualize performance statistics over time to measure growth and identify areas for improvement.
              </p>
            </div>
            ...
            <div className="border border-[#E5E5E5] rounded-lg p-6 bg-white">
              ...
              <h3 className="text-2xl font-bold text-[#171717] mb-2">For Coaches and Recruiters</h3>
              <p className="text-[#525252] text-lg">
                Track and visualize performance statistics over time to measure growth and identify areas for improvement.
              </p>
            </div>
            ...
            <div className="border border-[#E5E5E5] rounded-lg p-6 bg-white">
              ...
              <h3 className="text-2xl font-bold text-[#171717] mb-2">For Organization</h3>
              <p className="text-[#525252] text-lg">
                Connect directly with coaches, recruiters, and other athletes to expand your opportunities.
              </p>
            </div>
